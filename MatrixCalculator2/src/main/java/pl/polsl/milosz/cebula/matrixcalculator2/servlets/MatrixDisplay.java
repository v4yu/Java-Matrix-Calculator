...
/**
 * Class implements matrix display page servlet
 * @author Miłosz Cebula
 * @version 1.0
 */
@WebServlet(name = "MatrixDisplay", urlPatterns = {"/MatrixDisplay"})
public class MatrixDisplay extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            List<List<Double>> resultMatrix = (List<List<Double>>)session.getAttribute("transposition_results");
            
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MatrixDisplay</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            for(List<Double> tempList : resultMatrix ){
